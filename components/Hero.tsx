    ...
    <section id="home" className="pt-32 pb-20 md:pt-48 md:pb-32 bg-slate-50 text-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-7xl font-black leading-none text-[#1B2588] mb-4 tracking-tighter fade-in-up">
            Dutra Instalações <br/>Elétrica
          </h1>
          <h2 className="text-xl md:text-3xl text-slate-600 font-bold mb-8 uppercase tracking-wide fade-in-up [animation-delay:200ms]">
            Serviços elétricos completos e venda de materiais
          </h2>
          <p className="text-lg md:text-xl text-slate-500 mb-10 leading-relaxed max-w-2xl border-l-4 border-[#F1B524] pl-6 font-medium fade-in-up [animation-delay:400ms]">
            Atendimento especializado para Residencial, Condomínios, Consultórios e Hospitais no Rio de Janeiro.
          </p>
          <div className="flex flex-wrap gap-4 fade-in-up [animation-delay:600ms]">
