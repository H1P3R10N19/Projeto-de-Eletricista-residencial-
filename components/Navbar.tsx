...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900 text-white shadow-lg border-b border-blue-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0 flex items-center space-x-2">
            ...
            <span className="font-extrabold text-xl tracking-tight hidden sm:block">ELÉTRICA<span className="text-yellow-400">RIO</span></span>
          </div>
          
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8 font-semibold">
          ...
          <div>
            <a 
              ...
              className="bg-yellow-400 text-slate-900 px-6 py-2.5 rounded-full font-bold text-sm uppercase tracking-wider hover:bg-yellow-300 transition-all flex items-center gap-2"
            >
